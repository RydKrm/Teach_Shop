...
const SingleNewArrival = ({ singleArrivalProduct }) => {
    const { image, category, productName, price, discount, totalReview, rating, totalSell, shopId, shopName, size, quantity } = singleArrivalProduct;
    const productInfo = {
        productId: singleArrivalProduct._id,
        productName,
        image,
        quantity: 1,
        available: quantity,
    ...
    return (
        ...
        <div className="group rounded bg-white shadow-xl overflow-hidden relative h-96">
            ...
            <div className="pt-4 pb-3 px-4 ">
                <Link to={`productDetails/${singleArrivalProduct._id}`}>
